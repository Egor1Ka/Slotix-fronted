	...
	return (
		<div className="w-full max-w-lg space-y-6">
			...
			<div className="space-y-3">
				<p className="text-muted-foreground text-sm">Варианты</p>
			...
			<div className="space-y-3">
				<p className="text-muted-foreground text-sm">Размеры</p>
			...
			<div className="space-y-3">
				<p className="text-muted-foreground text-sm">Неактивное состояние</p>
				<div className="flex flex-wrap gap-2">
